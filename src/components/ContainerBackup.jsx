...
export default function ContainerBackup() {
    return (
        ...
        flex lg:gap-10 flex-row items-center justify-center flex-wrap-reverse lg:flex-nowrap px-20'>

            <div className='flex items-center lg:items-end lg:justify-center flex-col gap-6'>
                <div className='flex flex-col gap-2'>
                    <h1 className='text-primary-blue lg:text-[42px] text-3xl md:text-4xl font-poppins font-bold lg:text-end text-center'>Segurança e Backup em Nuvem</h1>
            ...
            <div>
                <img className='min-w-[200px] w-[240px]' src={lock} alt="imagem de uma pessoa da equipe de suporte" />
            </div>
