        ...
        flex lg:gap-20 md:gap-10 flex-row items-center justify-center flex-wrap-reverse lg:flex-nowrap md:flex-nowrap '>
            <div className='flex items-center lg:items-end md:items-end lg:justify-center md:justify-center flex-col gap-6'>
                <div className='flex flex-col gap-4'>
                    <h1 className='text-primary-blue lg:text-[40px] text-[25px] lg:leading-[50px] leading-[35px] md:text-4xl font-poppins font-semibold lg:text-end md:text-end text-center'>Segurança e Backup em Nuvem</h1>
            ...
            <div>
                <img className='min-w-[170px] lg:w-[190px] md:w-[180px]' src={lock} alt="imagem de uma pessoa da equipe de suporte" />
            </div>
