...
export default function ContainerBackup() {
    return (
        <div className='w-full px-10 lg:px-36 md:px-20 py-12 pb-24 bg-secondary-light dark:bg-quaternary-dark
        flex lg:gap-20 md:gap-10 flex-row items-center justify-center flex-wrap-reverse lg:flex-nowrap md:flex-nowrap '>
            <div className='flex items-center lg:items-end md:items-end lg:justify-center md:justify-center flex-col gap-6'>
                <div className='flex flex-col gap-4 '>
                    <h1 className='text-primary-blue lg:text-[40px] md:text-[35px] text-[25px] lg:leading-[45px] leading-[35px] md:text-4xl font-poppins font-semibold lg:text-end md:text-end text-center'>Segurança e Backup em Nuvem</h1>
