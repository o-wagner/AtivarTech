...
export default function ContainerSuporte() {
    return (
        <div className=' w-full lg:px-36 md:px-20 px-12 pt-28 py-20 bg-secondary-light dark:bg-quaternary-dark
        flex lg:gap-10 gap-4 flex-row items-center justify-center flex-wrap lg:flex-nowrap md:flex-nowrap'>
            ...
            <div className='flex items-center lg:items-start md:items-start lg:justify-center md:justify-center flex-col gap-6'>
                <div className='flex flex-col gap-4'>
                    <h1 className='text-primary-blue lg:text-[40px] text-[25px] md:text-[35px] font-poppins font-semibold lg:text-left md:text-left text-center '>Suporte Técnico Especializado</h1>
