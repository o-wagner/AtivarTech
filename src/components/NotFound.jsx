  ...
  return (
    <div className='h-screen text-dark-blue dark:text-vanilla bg-light-background dark:bg-dark-background flex flex-col items-center justify-center'>
      <div className='animate-fade-left flex flex-col items-center justify-center text-center'>
        <h1 className='dark:text-tertiary-dark text-slate-400/60 text-[50px] font-inter font-semibold'>Error 404 :'(</h1>
        <p className='dark:text-slate-700 font-inter text-sm text-blueish-gray pb-4'>A página que você esta procurando não foi encontrada.</p>
      </div>
