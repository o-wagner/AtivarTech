    ...
    return (
        <section name="service" id="service" className=' w-full pt-16 px-40'>
            ...
            <div className='w-full py-12 flex items-center justify-center flex-col gap-10'>
                    ...
                    {resources.map((r) => {
                        return (
                            <div key={r.title} className='bg-white hover:-translate-y-2 dark:bg-tertiary-dark
                             dark:hover:bg-hover-dark hover:drop-shadow-xl hover:cursor-pointer hover:bg-neutral-100 lg:min-h-[240px] min-w-[300px] 
                             drop-shadow-lg px-6 py-8 flex flex-col rounded-xl justify-evenly transition-transform duration-200'>
                                <div className='flex gap-2 flex-col' id="icon">
                                    {r.icon}
                ...
                <div className=' grid z-10 lg:grid-cols-2 grid-cols-1 min-w-[300px] gap-5 max-w-[1000px]'>
                    {service.map((s) => {
                        return (
