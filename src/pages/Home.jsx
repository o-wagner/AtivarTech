        ...
        <div className='bg-light-background dark:bg-dark-background'>
            ...
            <button onClick={() => handleClick()}>
                <a className={` ${support ? 'visible animate-fade-left duration-100' : 'invisible'}`}>
                    <div className='dark:bg-tertiary-dark bg-dark-blue border-slate-800 border dark:hover:bg-secondary-dark transition-colors drop-shadow-3xl duration-150 hover:bg-[#071b38] rounded-full lg:p-[16px] p-[12px] flex items-center justify-center bottom-6 right-8 z-30 fixed text-md lg:text-3xl'>
