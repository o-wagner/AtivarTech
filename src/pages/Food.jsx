...
function Food() {
  return (
    <div className='dark:bg-dark-background bg-light-background w-full'>
      <section id="heroFood" className='lg:h-[100dvh] h-auto w-full lg:pt-16 pt-10 lg:flex-row flex-wrap-reverse flex justify-center items-center px-10 lg:px-36 py-12 gap-5 lg:gap-[72px]'>
